...
@Composable
fun PlatosFondoScreen(navController: NavController, userViewModel: UserViewModel) {
    var platosFondo by remember { mutableStateOf<List<Plato>>(emptyList()) }
