...
@Composable
fun PlatosEntradaScreen(navController: NavController, userViewModel: UserViewModel) {
    var platosEntrada by remember { mutableStateOf<List<Plato>>(emptyList()) }
